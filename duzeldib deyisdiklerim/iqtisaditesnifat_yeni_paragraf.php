        ...
        <form action="nedmin/islem.php" method="POST">
          <div class="form-group col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-md-5 col-sm-5 col-xs-12">
              <select class=" form-control bolme select2_single"  name="iqtisaditesnifat_kb_id">
                <option></option>
                <?php 
            ...
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="text" min="0" class="form-control"  id="yeniparagrafad" placeholder="Adı" name="iqtisaditesnifat_paragraf_ad">
              </div>
            </div> 
            ...
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="col-md-5 col-sm-5 col-xs-12">
                <input type="number" min="0" class="form-control"  id="yeniparagrafkod" placeholder="Kod" name="iqtisaditesnifat_paragraf_kod">
              </div>
            </div> 
              ...
              <div class="modalcontiner" >
                ...
                <div class="container-fluid" style="text-align: center !important;">
                  <div class="row " style="text-align: center !important;"> 
                    <button type="submit" class="btn  btn-danger col-md-5 m-2 " style="font-size: 20px;" name="iqtisaditesnifat_yeni_paragraf">Təsdiqlə</button>              
...
<script >
 function iqtisadi_tesnifat_yeni_paragraf(){
   ...
   var yeni_paragraf_ad=document.getElementById("yeniparagrafad").value; 
   var yeni_paragraf_kod=document.getElementById("yeniparagrafkod").value;
